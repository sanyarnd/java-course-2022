...
class MockBeanTest {
	...
	void shouldMapUser() {
		// given
		Mockito.when(repository.getAllUsers()).
...
//		assertThat(user2.getFirstName(), equalTo("Some invalid value")); // TODO invalid test cases
//		assertThat(user2.getLastName(), is(notNullValue()) );
	}
